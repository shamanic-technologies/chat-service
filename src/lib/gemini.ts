...
// and can burn the output budget reasoning before emitting JSON (incident
// 2026-06-24, brand-service ICP/audiences/extract-fields). The /chat path was
// already fixed (commit 1991af2); this is the same bounded-config fix on the
// /complete path. PR #133's old `thinkingBudget: 0` is
